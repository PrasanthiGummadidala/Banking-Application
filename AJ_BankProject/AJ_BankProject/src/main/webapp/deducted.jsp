...
<head>
    ...
    <title>ICICI - BANK: Deposit Confirmation</title>
    <style>
        body {
...
<body>
    ...
    <div class="container">
        <div class="content">
            <%
                CheckBalanceBean bb = (CheckBalanceBean) session.getAttribute("deducted");
            %>
            <h2>Account Info</h2>
           <%! LocalDate  = LocalDate.now();%>
         
            <p><%= "Your A/c  "+bb.getAccountNo() +" is  debited With Rs. "+ bb.getAmount()+" on "+d+" For More Information .Not You ? Call "+Math.random() %></p>
        </div>
        <div class="footer">
            <p>Services:</p>
            <p>
